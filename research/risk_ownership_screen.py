...
def main() -> int:
    ...
    recovery_confirmation = contract["parameters"]["recovery_confirmation"]
    if risk_confirmation != 2 or recovery_confirmation != 2:
        raise ValueError("confirmation structure differs from the frozen contract")
